...
public class MyAccountsPage extends Utility {
    ...
    public void clickOnMyAccountLink() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on myAccount Link"+myAccountLink);
    }

    public String getRegisterAccountMessage() {
        Reporter.log("getRegisterAccountMessage" + getRegisterAccountText.toString());
        CustomListeners.test.log(Status.PASS,"getRegisterAccountMessage"+getRegisterAccountText);
    ...
    public String getReturningCustomerMessage() {
        ...
        CustomListeners.test.log(Status.PASS,"getReturningCustomerMessage" + getReturningCustomerText);
        return getTextFromElement(getReturningCustomerText);
    }

    public void enterFirstName(String name) {
        Reporter.log("Enter First Name " + name + " in field" + firstName.toString());
        CustomListeners.test.log(Status.PASS,"Enter First Name"+ name + " in field"+ firstName);
    ...
    public void enterEmailId(String email) {
        ...
        CustomListeners.test.log(Status.PASS,"Enter email"+enterEmailId);
        sendTextToElement(enterEmailId, email);
    }

    public void enterPhoneNumber(String phone) {
        Reporter.log("Enter " + phone + "Phone Number" + enterPhoneNumber.toString());
        CustomListeners.test.log(Status.PASS,"Enter phone number"+enterPhoneNumber);
