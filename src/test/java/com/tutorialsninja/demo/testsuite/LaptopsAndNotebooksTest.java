...
2.25 Verify the message “Warning: Payment method required!”
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        Assert.assertEquals(laptopsAndNotebooksPage.getVerifyProductSonyVaio(), "Sony VAIO", "Message not dispalyed");
        ...
        laptopsAndNotebooksPage.enterName("Shital");
        laptopsAndNotebooksPage.enterLastName("Sanghani");
